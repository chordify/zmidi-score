...
-- NOTE: when training wget pop data the warning generated by sumNSWProf is
-- thrown regularly. I vaguely remember that this was not very harmful, but 
-- I cannot exactly recall why at the moment. Figure this out.
